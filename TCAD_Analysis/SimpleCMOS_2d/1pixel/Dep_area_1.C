...
TGraph *graph= new TGraph("../TCAD_Analysis/SimpleCmos_2d/1pixel/Bias_Dep_SimplePixel1.txt","%lg %lg");		// creates a graph called graph and reads file
